...
const keyWords: Record<LanguageEnum, Record<string, string | number>> = {
  ...
  tr: {
    ...
    code: "Ürün Kodu",
    title: "Ürün başlığı",
    description: "Açıklama (Teknik Özellikler)",
    mainImage: "Ana resim",
    schemeImage: "Şema resmi",
    boxImage: "Paket resmi",
    allRights: "FE LLC Nova Plumbing Solutions HER HAKKI SAKLIDIR",
    moreInfo: "Daha fazla bilgi için lütfen üreticiyle iletişime geçin",
