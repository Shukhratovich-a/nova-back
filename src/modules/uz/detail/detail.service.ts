...
import { DetailCategoryService } from "@modules/uz/detail-category/detail-category.service";
...
export class DetailService {
  constructor(
    @InjectRepository(DetailEntity, "db_uz") private readonly detailRepository: Repository<DetailEntity>,
