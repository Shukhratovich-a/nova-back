...
import { CategoryService } from "@modules/eg/category/category.service";
...
export class SubcategoryService {
  constructor(
    @InjectRepository(SubcategoryEntity, "db_eg") private readonly subcategoryRepository: Repository<SubcategoryEntity>,
