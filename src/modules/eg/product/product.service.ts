...
import { DetailService } from "@modules/eg/detail/detail.service";
import { PdfService } from "@modules/eg/pdf/pdf.service";
...
export class ProductService {
  constructor(
    @InjectRepository(ProductEntity, "db_eg") private readonly productRepository: Repository<ProductEntity>,
