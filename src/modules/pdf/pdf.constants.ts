...
export const pdf = async (dto: ProductDto) => {
  ...
  const mainImage = `data:image/jpeg;base64,${mainImageBuffer.toString("base64")}`;
  const schemeImage = `data:image/jpeg;base64,${schemeImageBuffer.toString("base64")}`;
  const boxImage = `data:image/jpeg;base64,${boxImageBuffer.toString("base64")}`;
        ...
        >
            ...
            <div style="display: flex; flex-direction: column; flex-grow: 1">
              <div style="flex-grow: 1; border-bottom: 1px solid #1b5a7d">
                ...
                <div style="display: flex; justify-content: center; align-items: center; flex-grow: 1">
                  <img
                    style="width: 194px; height: 194px; object-fit: contain"
                    src="${mainImage}"
                    alt=""
                  />
                </div>
          ...
          >
            ...
            <div
              ...
              "
            >
              For more information please contact with the manufacturer
            </div>
